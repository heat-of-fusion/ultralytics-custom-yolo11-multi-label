...
if __name__ == '__main__':
    ...
    # visualize_batch(batch, f'./batch.png')
    # exit()
    ...
    for batch in tqdm(test_loader, desc = f'Inferencing...'):
        ...
        # BBOX: [BATCH, N_ANCHOR, 4]
        # CLASS: [BATCH, N_ANCHOR, N_CLS]
        # KEYPOINT: [BATCH, N_ANCHOR, N_KPT]
        ...
        for b_idx in range(img.shape[0]):
            ...
            for a_idx in range(len(pred_bboxes[b_idx])):
                ...
                # cls_name = data['names'][pred_scores[b_idx][a_idx].argmax()]
